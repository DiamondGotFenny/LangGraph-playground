...
SYSTEM_PROMPT = "\n".join([
    ...
    "4) Use NOTE (draft) before committing: update the note to reflect the customer's desired final order.",
    "   Do NOT say the order is placed until you commit.",
    "5) Commit correctly: if no active order, order_create_from_note; otherwise order_update_to_match_note (never create duplicates).",
